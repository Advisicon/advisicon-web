...
Eventbrite.prototype = {
  ...
  'api_methods': ['discount_new', 'discount_update', 'event_copy', 'event_get', 'event_list_attendees', 'event_list_discounts', 'event_new', 'event_search', 'event_update', 'organizer_list_events', 'organizer_new', 'organizer_update', 'organizer_get', 'payment_update', 'ticket_new', 'ticket_update', 'user_get', 'user_list_events', 'user_list_abbr_events','user_list_organizers', 'user_list_tickets', 'user_list_venues', 'user_new', 'user_update', 'venue_new', 'venue_get', 'venue_update'],
  ...
  'utils': {
    ...
    'eventListRow': function( evnt ){
      ...
      if( evnt.venue !== undefined && evnt.venue.name !== undefined && evnt.venue.name !== ''){ 
  	  ...
  	  if( venue_name !== undefined && venue_name !== 'Online' ){
        ...
        venue_map_link = "<a href='" + venue_map_url + "' title='Map " + venue_name + " on google maps!'>" + venue_name + "</a>";
  	  } else {
        venue_map_link = venue_name;
      }
      ...
      html = "<div class='eb_event_list_item' id='evnt_div_" + evnt.id + "'>" + 
             ...
             "<span class='eb_event_list_location'>" + venue_map_link + "</span>" +
