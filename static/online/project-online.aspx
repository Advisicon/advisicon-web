...
<html class='no-js'>
  ...
  <div role='main'>
    <div id='content'>
      <img alt='Advisicon, Inc.' border='0' height='108' id='advisiconBanner' src='/pix/top-banner.png' usemap='#Map' width='950' />
      <div class='navbar'>
  ...
  <li>
    <a href='/our-certifications.html' title='Learn more about our competencies as a Microsoft Certified Partner'>
      <img alt='Microsoft Certified Partner' border='0' height='58' src='/pix/MSFT_Partner_white.png' width='150' />
    </a>
  </li>
  <li>
    ...
    Project Management Institute, Inc.
      ...
      <aside id='secondaryContent'>
        ...
        <div class='rPopBox'>
          ...
          <ul id='feedContent'>
            <li>
              Visit the <a href="http://blog.advisicon.com/" title="view the Advisicon blog">Advisicon blog</a> to see our most recent blog posts.
            </li>
          </ul>
        </div>
        <div class='rPopBox'>
          ...
          <ul>
            <li itemscope='itemscope' itemtype='http://schema.org/Product'>
              <a href="/tools/msp-rex.html" itemprop="name url">MSP-Rex</a> (<span itemprop="description">Report Extractor</span>)
            </li>
            <li itemscope='itemscope' itemtype='http://schema.org/Product'>
              <a href="/tools/skill-tracker.html" itemprop="name url">Skill Tracker</a>
            </li>
          </ul>
        </div>
